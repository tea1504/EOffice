...
function CanBoEdit({ donVi }) {
  ...
  const handleLockButtonClick = (e) => {
    e.preventDefault();
    dispatch(lockDataAsync(form._id));
    dispatch(getDataAsync());
  };
  ...
  return (
    <Form onSubmit={handleFormSubmit}>
      ...
      <FormGroup row>
        ...
        <Col md={10}>
          <ReactSelect
            ...
            options={donVi}
            value={donVi.filter((e) => e._id === form.donvi)}
      ...
      <FormGroup>
        <Button
          className={clsx("text-white w-100",form.actived?'btn-danger':'btn-success')}
          style={{
            boxShadow: "0 1px 1px rgb(0 0 0 / 8%)",
          }}
          onClick={handleLockButtonClick}
        >
          {form.actived ? <b>Khóa tài khoản</b> : <b>Mở khóa tài khoản</b>}
        </Button>
      </FormGroup>
      <FormGroup>
